...
export const metadata: Metadata = {
  title: {
    default: "UK ETA 2026: £20, ansök på 10 minuter – komplett guide på svenska",
    template: "%s ‐ UK ETA-guiden",
  },
  description:
  ...
  keywords:
    "UK ETA, UK ETA 2026, Storbritannien, reseauktorisering, Electronic Travel Authorisation, ETA-ansökan, Sverige, avgift £20",
  robots: { index: true, follow: true },
  metadataBase: new URL("https://eta-se.com"),
  openGraph: {
    title: "UK ETA 2026: £20, ansök på 10 minuter – komplett guide på svenska",
    description:
      "Komplett guide till UK ETA 2026 på svenska. Vid resa till Storbritannien krävs ETA sedan 2 april 2025 — ansök minst 3 dagar före avresan. Kom ihåg att ansöka i god tid.",
    locale: "sv_SE",
    type: "website",
    siteName: "UK ETA-guiden",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "UK ETA-guiden — Big Ben och Westminsterbron i London",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "UK ETA-guiden 2026 | Komplett guide på svenska steg för steg",
    description:
      "Komplett guide till UK ETA 2026 på svenska — avgift £20, beslut oftast inom några minuter, giltig i 2 år.",
    images: ["/og-image.jpg"],
  },
};
