...
export default function Page() {
  return (<div>
      ...
      <section className="bg-white"><div className="max-w-4xl mx-auto px-6 py-10">
        <div className="border-l-4 border-[#022444] bg-gray-50 p-5 rounded-r-lg">
          <p className="font-semibold text-[#022444] mb-1">Nästa steg: Standard Visitor-visum</p>
          <p className="text-sm text-gray-600 mb-3">Efter ett ETA-avslag är visum enda vägen till Storbritannien. Se kostnad (£135), tid och process.</p>
          <Link href="/eta-info/standard-visitor-visa" className="inline-block text-sm font-semibold text-white bg-[#022444] px-4 py-2 rounded hover:bg-[#033866] transition-colors">Guide: Standard Visitor-visum för UK →</Link>
        </div>
      </div></section>
      <section className="bg-gray-50"><div className="max-w-4xl mx-auto px-6 py-8 text-sm text-gray-500"><p className="mb-2 font-bold text-gray-700">Officiella källor (GOV.UK)</p><ul className="space-y-1"><li><a href="https://www.gov.uk/eta" target="_blank" rel="noopener noreferrer" className="text-[#022444] underline">https://www.gov.uk/eta</a></li><li><a href="https://homeofficemedia.blog.gov.uk/electronic-travel-authorisation-eta-factsheet-april-2026/" target="_blank" rel="noopener noreferrer" className="text-[#022444] underline">https://homeofficemedia.blog.gov.uk/electronic-travel-authorisation-eta-factsheet-april-2026/</a></li></ul></div></section>
